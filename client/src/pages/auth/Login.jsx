...
const PosterBackground = () => {
  // Same source pattern as HeroSection: use dummyShowsData directly, no image_base_url prefix
...
const Login = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Unable to login. Check your connection or credentials.");
    }
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 bg-[#05020A]">
      ...
      <div className="relative z-10 w-full max-w-md bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 shadow-xl animate-[fadeIn_0.3s_ease-out]">
        <h2 className="text-2xl font-semibold text-center mb-1 text-white">Welcome back</h2>
        <p className="text-sm text-center text-gray-400 mb-6">Log in to continue booking</p>
